...
def enhancer_generator_no_len(images, method='gfpgan', bg_upsampler='realesrgan'):
    ...
    # cache_path = os.path.join(user_directory, '.cache', 'modelscope', 'hub', 'wwd123', 'sadtalker')
    cache_path = snapshot_download("wwd123/sadtalker", "v1.0.0")
    model_path = os.path.join(cache_path, 'gfpgan/weights', model_name + '.pth')
