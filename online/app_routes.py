...
from online.app_text import DEFAULT_QUERY, SANITIZED_AVATARS, repair_text
# 从文本处理模块导入默认查询文本、清理后的角色配置、文本乱码修复函数
import online.app_services as app_services
# 导入应用服务模块（使用别名），用于获取系统状态和RAG系统实例
from online.session_manager import SessionManager
# 从会话管理模块导入会话管理器
from online.utils import normalize_username
# 从工具模块导入用户名规范化函数
